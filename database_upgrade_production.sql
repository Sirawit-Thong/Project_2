-- ============================================================
-- PRODUCTION UPGRADE — วางใน phpMyAdmin (เลือก DB if0_40083938_equipment_db ก่อน)
-- ตัด USE ออกเพราะ shared hosting ห้ามสลับ database
-- phpMyAdmin จัดการ charset UTF-8 ให้เอง
-- ============================================================
SET NAMES utf8mb4;
...
ALTER TABLE items ADD COLUMN category_id INT DEFAULT NULL AFTER set_id;
