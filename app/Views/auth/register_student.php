        ...
        <?php else: ?>
            ...
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="sid" name="sid" placeholder="ตัวเลข 12 หลัก" maxlength="12" required value="<?= htmlspecialchars($_POST['sid'] ?? '') ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="class" name="class" placeholder="เช่น ITS36641N" value="<?= htmlspecialchars($_POST['class'] ?? '') ?>">
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
            ...
            <div class="text-center">
                ...
                <p>สำหรับบุคลากร/อาจารย์? <a href="<?= SITE_URL ?>/register/teacher">ลงทะเบียนอาจารย์</a></p>
            </div>
        <?php endif; ?>
    </div>
</div>
