 ...
 *   $totalRepairs, $pendingRepairs, $recentRepairs
 */
$user = getCurrentUser();
?>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm mb-4 bg-primary text-white overflow-hidden position-relative">
            <div class="card-body text-center p-4 position-relative" style="z-index: 1;">
                ...
                <p class="mb-4 text-white-50">แจ้งซ่อมได้ทันที ติดตามสถานะได้ตลอดเวลา พร้อมแจ้งเตือนเมื่อซ่อมเสร็จ</p>
            ...
            <i class="bi bi-laptop position-absolute" style="font-size: 8rem; opacity: 0.1; right: -20px; bottom: -20px; color: white;"></i>
        </div>
    </div>
</div>
